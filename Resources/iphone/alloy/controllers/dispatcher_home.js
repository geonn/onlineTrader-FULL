...
function Controller() {
    ...
    refreshPage ? $.__views.__alloyId104.addEventListener("touchend", refreshPage) : __defers["$.__views.__alloyId104!touchend!refreshPage"] = true;
    ...
    $.__views.header.add($.__views.__alloyId105);
    ...
    __defers["$.__views.__alloyId104!touchend!refreshPage"] && $.__views.__alloyId104.addEventListener("touchend", refreshPage);
    _.extend($, exports);
}
