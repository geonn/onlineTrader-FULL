...
function Controller() {
    ...
    $.__views.header.add($.__views.__alloyId85);
    ...
    $.__views.header.add($.__views.__alloyId86);
    ...
    $.__views.composetracking_win.add($.__views.__alloyId89);
    ...
    $.__views.__alloyId89.add($.__views.trackingMessage);
