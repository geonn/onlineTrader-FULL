...
function Controller() {
    ...
    $.__views.__alloyId99 = Alloy.createController("_subheader", {
        id: "__alloyId99",
        __parentSymbol: $.__views.dealer_orderlist
    });
    $.__views.__alloyId99.setParent($.__views.dealer_orderlist);
    ...
    $.__views.__alloyId102.add($.__views.orderlistview);
