    ...
    $.extend($.ui, {
        plugin: {
            ...
            call: function(instance, name, args) {
                ...
                for (i = 0; set.length > i; i++) instance.options[set[i][0]] && set[i][1].apply(instance.element, args);
            }
        },
...
(function($, undefined) {
    ...
    $.widget.extend = function(target) {
        var key, value, input = slice.call(arguments, 1), inputIndex = 0, inputLength = input.length;
        for (;inputLength > inputIndex; inputIndex++) for (key in input[inputIndex]) {
...
(function($) {
    ...
    $.widget("ui.mouse", {
        ...
        _mouseMove: function(event) {
            if ($.ui.ie && (!document.documentMode || 9 > document.documentMode) && !event.button) return this._mouseUp(event);
            if (this._mouseStarted) {
...
(function($, undefined) {
    ...
    $.fn.position = function(options) {
        ...
        return this.each(function() {
            ...
            options.using && (using = function(props) {
                ...
                elemWidth > targetWidth && targetWidth > abs(left + right) && (feedback.horizontal = "center");
                elemHeight > targetHeight && targetHeight > abs(top + bottom) && (feedback.vertical = "middle");
    ...
    $.ui.position = {
        fit: {
            left: function(position, data) {
                ...
                } else position.left = overRight > 0 && 0 >= overLeft ? withinOffset : overLeft > overRight ? withinOffset + outerWidth - data.collisionWidth : withinOffset; else overLeft > 0 ? position.left += overLeft : overRight > 0 ? position.left -= overRight : position.left = max(position.left - collisionPosLeft, position.left);
            },
            top: function(position, data) {
                ...
                } else position.top = overBottom > 0 && 0 >= overTop ? withinOffset : overTop > overBottom ? withinOffset + outerHeight - data.collisionHeight : withinOffset; else overTop > 0 ? position.top += overTop : overBottom > 0 ? position.top -= overBottom : position.top = max(position.top - collisionPosTop, position.top);
            }
        },
        flip: {
            left: function(position, data) {
                ...
                if (0 > overLeft) {
                    ...
                    (0 > newOverRight || abs(overLeft) > newOverRight) && (position.left += myOffset + atOffset + offset);
                } else if (overRight > 0) {
                    newOverLeft = position.left - data.collisionPosition.marginLeft + myOffset + atOffset + offset - offsetLeft;
                    (newOverLeft > 0 || overRight > abs(newOverLeft)) && (position.left += myOffset + atOffset + offset);
                }
            },
            top: function(position, data) {
                ...
                if (0 > overTop) {
                    ...
                    position.top + myOffset + atOffset + offset > overTop && (0 > newOverBottom || abs(overTop) > newOverBottom) && (position.top += myOffset + atOffset + offset);
                } else if (overBottom > 0) {
                    newOverTop = position.top - data.collisionPosition.marginTop + myOffset + atOffset + offset - offsetTop;
                    position.top + myOffset + atOffset + offset > overBottom && (newOverTop > 0 || overBottom > abs(newOverTop)) && (position.top += myOffset + atOffset + offset);
                }
            }
        },
        flipfit: {
    ...
    (function() {
        ...
        $.support.offsetFractions = offsetLeft > 10 && 11 > offsetLeft;
...
(function($) {
    ...
    $.widget("ui.accordion", {
        ...
        _create: function() {
            ...
            options.collapsible || false !== options.active && null != options.active || (options.active = 0);
            this._processPanels();
            0 > options.active && (options.active += this.headers.length);
            this._refresh();
        },
        ...
        _setOption: function(key, value) {
            ...
            "collapsible" !== key || value || false !== this.options.active || this._activate(0);
            if ("icons" === key) {
                this._destroyIcons();
                value && this._createIcons();
            }
            "disabled" === key && this.headers.add(this.headers.next()).toggleClass("ui-state-disabled", !!value);
        },
        ...
        refresh: function() {
            ...
            if (false === options.active && true === options.collapsible || !this.headers.length) {
                ...
                this.active = $();
            } else if (false === options.active) this._activate(0); else if (this.active.length && !$.contains(this.element[0], this.active[0])) if (this.headers.length === this.headers.find(".ui-state-disabled").length) {
                options.active = false;
                this.active = $();
        ...
        _eventHandler: function(event) {
            ...
            event.preventDefault();
            if (clickedIsActive && !options.collapsible || false === this._trigger("beforeActivate", event, eventData)) return;
...
(function($) {
    $.widget("ui.autocomplete", {
        ...
        _create: function() {
            ...
            this._on(this.menu.element, {
                ...
                menufocus: function(event, ui) {
                    ...
                    false !== this._trigger("focus", event, {
                        item: item
                ...
                menuselect: function(event, ui) {
                    ...
                    false !== this._trigger("select", event, {
                        item: item
        ...
        search: function(value, event) {
            ...
            if (false === this._trigger("search", event)) return;
    ...
    $.widget("ui.button", {
        ...
        _setOption: function(key, value) {
            ...
            if ("disabled" === key) {
                ...
                value && this.buttonElement.removeClass("ui-state-focus");
                return;
            }
            this._resetButton();
        },
...
(function($, undefined) {
    ...
    $.extend(Datepicker.prototype, {
            ...
            if (this._get(inst, "autoSize") && !inst.inline) {
                ...
                if (dateFormat.match(/[DM]/)) {
                    findMax = function(names) {
                        max = 0;
                        maxI = 0;
                        for (i = 0; names.length > i; i++) if (names[i].length > max) {
                            max = names[i].length;
                            maxI = i;
                        }
                        return maxI;
        ...
        _isDisabledDatepicker: function(target) {
            ...
            for (var i = 0; this._disabledInputs.length > i; i++) if (this._disabledInputs[i] === target) return true;
            return false;
        },
        ...
        _doKeyDown: function(event) {
            ...
            if ($.datepicker._datepickerShowing) switch (event.keyCode) {
              ...
              default:
                handled = false;
            } else 36 === event.keyCode && event.ctrlKey ? $.datepicker._showDatepicker(this) : handled = false;
            if (handled) {
                event.preventDefault();
        ...
        _findPos: function(obj) {
            ...
            while (obj && ("hidden" === obj.type || 1 !== obj.nodeType || $.expr.filters.hidden(obj))) obj = obj[isRTL ? "previousSibling" : "nextSibling"];
            position = $(obj).offset();
        ...
        parseDate: function(format, value, settings) {
            ...
            var iFormat, dim, extra, date, iValue = 0, shortYearCutoffTemp = (settings ? settings.shortYearCutoff : null) || this._defaults.shortYearCutoff, shortYearCutoff = "string" != typeof shortYearCutoffTemp ? shortYearCutoffTemp : new Date().getFullYear() % 100 + parseInt(shortYearCutoffTemp, 10), dayNamesShort = (settings ? settings.dayNamesShort : null) || this._defaults.dayNamesShort, dayNames = (settings ? settings.dayNames : null) || this._defaults.dayNames, monthNamesShort = (settings ? settings.monthNamesShort : null) || this._defaults.monthNamesShort, monthNames = (settings ? settings.monthNames : null) || this._defaults.monthNames, year = -1, month = -1, day = -1, doy = -1, literal = false, lookAhead = function(match) {
                var matches = format.length > iFormat + 1 && format.charAt(iFormat + 1) === match;
                matches && iFormat++;
                return matches;
            ...
            for (iFormat = 0; format.length > iFormat; iFormat++) if (literal) "'" !== format.charAt(iFormat) || lookAhead("'") ? checkLiteral() : literal = false; else switch (format.charAt(iFormat)) {
              case "d":
                day = getNumber("d");
                break;
              ...
              case "'":
                lookAhead("'") ? checkLiteral() : literal = true;
                break;

              default:
                checkLiteral();
            }
            if (value.length > iValue) {
        ...
        formatDate: function(format, date, settings) {
            ...
            var iFormat, dayNamesShort = (settings ? settings.dayNamesShort : null) || this._defaults.dayNamesShort, dayNames = (settings ? settings.dayNames : null) || this._defaults.dayNames, monthNamesShort = (settings ? settings.monthNamesShort : null) || this._defaults.monthNamesShort, monthNames = (settings ? settings.monthNames : null) || this._defaults.monthNames, lookAhead = function(match) {
                ...
                var num = "" + value;
                if (lookAhead(match)) while (len > num.length) num = "0" + num;
                return num;
            }, formatName = function(match, value, shortNames, longNames) {
                return lookAhead(match) ? longNames[value] : shortNames[value];
            }, output = "", literal = false;
            if (date) for (iFormat = 0; format.length > iFormat; iFormat++) if (literal) "'" !== format.charAt(iFormat) || lookAhead("'") ? output += format.charAt(iFormat) : literal = false; else switch (format.charAt(iFormat)) {
              case "d":
              ...
              case "y":
                output += lookAhead("y") ? date.getFullYear() : (10 > date.getYear() % 100 ? "0" : "") + date.getYear() % 100;
                break;
        ...
        _possibleChars: function(format) {
            ...
            for (iFormat = 0; format.length > iFormat; iFormat++) if (literal) "'" !== format.charAt(iFormat) || lookAhead("'") ? chars += format.charAt(iFormat) : literal = false; else switch (format.charAt(iFormat)) {
              case "d":
              case "m":
              case "y":
              case "@":
        ...
        _generateHTML: function(inst) {
            ...
            html = "";
            dow;
            for (row = 0; numMonths[0] > row; row++) {
                group = "";
                this.maxRows = 4;
                for (col = 0; numMonths[1] > col; col++) {
        ...
        _generateMonthYearHeader: function(inst, drawMonth, drawYear, minDate, maxDate, secondary, monthNames, monthNamesShort) {
            ...
            if (secondary || !changeMonth) monthHtml += "<span class='ui-datepicker-month'>" + monthNames[drawMonth] + "</span>"; else {
                ...
                for (month = 0; 12 > month; month++) (!inMinYear || month >= minDate.getMonth()) && (!inMaxYear || maxDate.getMonth() >= month) && (monthHtml += "<option value='" + month + "'" + (month === drawMonth ? " selected='selected'" : "") + ">" + monthNamesShort[month] + "</option>");
                monthHtml += "</select>";
            }
        ...
        _isInRange: function(inst, date) {
            ...
            return (!minDate || date.getTime() >= minDate.getTime()) && (!maxDate || date.getTime() <= maxDate.getTime()) && (!minYear || date.getFullYear() >= minYear) && (!maxYear || maxYear >= date.getFullYear());
        },
...
(function($) {
    ...
    $.widget("ui.dialog", {
        ...
        _setOptions: function(options) {
            ...
            $.each(options, function(key, value) {
                ...
                key in sizeRelatedOptions && (resize = true);
        ...
        _setOption: function(key, value) {
            ...
            if ("resizable" === key) {
                ...
                isResizable || false === value || this._makeResizable();
            }
    ...
    false !== $.uiBackCompat && $.widget("ui.dialog", $.ui.dialog, {
        _position: function() {
            var isVisible, position = this.options.position, myAt = [], offset = [ 0, 0 ];
            if (position) {
                if ("string" == typeof position || "object" == typeof position && "0" in position) {
                    ...
                    position = {
                        my: myAt[0] + (0 > offset[0] ? offset[0] : "+" + offset[0]) + " " + myAt[1] + (0 > offset[1] ? offset[1] : "+" + offset[1]),
                        at: myAt.join(" ")
                    };
                }
...
(function($) {
    $.widget("ui.draggable", $.ui.mouse, {
        ...
        _mouseStop: function(event) {
            ...
            "invalid" === this.options.revert && !dropped || "valid" === this.options.revert && dropped || true === this.options.revert || $.isFunction(this.options.revert) && this.options.revert.call(this.element, dropped) ? $(this.helper).animate(this.originalPosition, parseInt(this.options.revertDuration, 10), function() {
                false !== that._trigger("stop", event) && that._clear();
            }) : false !== this._trigger("stop", event) && this._clear();
            return false;
        },
        _mouseUp: function(event) {
            ...
            $.each(inst.sortables, function() {
                ...
                if (this.instance._intersectsWith(this.instance.containerCache)) {
                    ...
                    $.each(inst.sortables, function() {
                        ...
                        this.instance.helperProportions = inst.helperProportions;
                        this.instance.offset.click = inst.offset.click;
                        this !== thisSortable && this.instance._intersectsWith(this.instance.containerCache) && $.contains(thisSortable.instance.element[0], this.instance.element[0]) && (innermostIntersecting = false);
    ...
    $.ui.plugin.add("draggable", "scroll", {
        ...
        drag: function(event) {
            ...
            if (i.scrollParent[0] !== document && "HTML" !== i.scrollParent[0].tagName) {
                o.axis && "x" === o.axis || (i.overflowOffset.top + i.scrollParent[0].offsetHeight - event.pageY < o.scrollSensitivity ? i.scrollParent[0].scrollTop = scrolled = i.scrollParent[0].scrollTop + o.scrollSpeed : event.pageY - i.overflowOffset.top < o.scrollSensitivity && (i.scrollParent[0].scrollTop = scrolled = i.scrollParent[0].scrollTop - o.scrollSpeed));
            ...
            false !== scrolled && $.ui.ddmanager && !o.dropBehaviour && $.ui.ddmanager.prepareOffsets(i, event);
        }
    });
...
(function($) {
    ...
    $.widget("ui.droppable", {
        ...
        _destroy: function() {
            ...
            for (;drop.length > i; i++) drop[i] === this && drop.splice(i, 1);
    ...
    $.ui.intersect = function(draggable, droppable, toleranceMode) {
        ...
        switch (toleranceMode) {
          ...
          case "intersect":
            return x1 + draggable.helperProportions.width / 2 > l && r > x2 - draggable.helperProportions.width / 2 && y1 + draggable.helperProportions.height / 2 > t && b > y2 - draggable.helperProportions.height / 2;
    ...
    $.ui.ddmanager = {
        ...
        drop: function(draggable, event) {
            ...
            $.each(($.ui.ddmanager.droppables[draggable.options.scope] || []).slice(), function() {
                ...
                !this.options.disabled && this.visible && $.ui.intersect(draggable, this, this.options.tolerance) && (dropped = this._drop.call(this, event) || dropped);
        ...
        drag: function(draggable, event) {
            ...
            $.each($.ui.ddmanager.droppables[draggable.options.scope] || [], function() {
                ...
                this[c] = true;
                this["isout" === c ? "isover" : "isout"] = false;
...
(function($, undefined) {
    ...
    (function(jQuery, undefined) {
        function clamp(value, prop, allowEmpty) {
            ...
            return 0 > value ? 0 : value > type.max ? type.max : value;
        }
        ...
        function hue2rgb(p, q, h) {
            h = (h + 1) % 1;
            if (1 > 6 * h) return p + 6 * (q - p) * h;
            if (1 > 2 * h) return q;
            if (2 > 3 * h) return p + 6 * (q - p) * (2 / 3 - h);
            return p;
        }
    ...
    (function() {
        ...
        $.extend($.effects, {
            ...
            save: function(element, set) {
                for (var i = 0; set.length > i; i++) null !== set[i] && element.data(dataSpace + set[i], element[0].style[set[i]]);
            },
            restore: function(element, set) {
                var val, i;
                for (i = 0; set.length > i; i++) if (null !== set[i]) {
    ...
    (function() {
        ...
        $.extend(baseEasings, {
            ...
            Bounce: function(p) {
                var pow2, bounce = 4;
                while (((pow2 = Math.pow(2, --bounce)) - 1) / 11 > p) ;
...
(function($) {
    ...
    $.effects.effect.blind = function(o, done) {
        var wrapper, distance, margin, el = $(this), props = [ "position", "top", "bottom", "left", "right", "height", "width" ], mode = $.effects.setMode(el, o.mode || "hide"), direction = o.direction || "up", vertical = rvertical.test(direction), ref = vertical ? "height" : "width", ref2 = vertical ? "top" : "left", motion = rpositivemotion.test(direction), animation = {}, show = "show" === mode;
...
(function($) {
    $.effects.effect.drop = function(o, done) {
        ...
        el.show();
        $.effects.createWrapper(el);
        distance = o.distance || el["top" === ref ? "outerHeight" : "outerWidth"](true) / 2;
...
(function($) {
    ...
    $.effects.effect.scale = function(o, done) {
        var el = $(this), options = $.extend(true, {}, o), mode = $.effects.setMode(el, o.mode || "effect"), percent = parseInt(o.percent, 10) || (0 === parseInt(o.percent, 10) ? 0 : "hide" === mode ? 0 : 100), direction = o.direction || "both", origin = o.origin, original = {
            height: el.height(),
            width: el.width(),
...
(function($) {
    $.widget("ui.menu", {
            ...
            this._on({
                ...
                "click .ui-menu-item:has(a)": function(event) {
                    ...
                    if (!this.mouseHandled && target.not(".ui-state-disabled").length) {
                        this.select(event);
                        event.isPropagationStopped() || (this.mouseHandled = true);
        ...
        _keydown: function(event) {
            ...
            switch (event.keyCode) {
              ...
              default:
                ...
                character === prev ? skip = true : character = prev + character;
        ...
        _startOpening: function(submenu) {
            ...
            if ("true" !== submenu.attr("aria-hidden")) return;
        ...
        _move: function(direction, filter, event) {
            ...
            next && next.length && this.active || (next = this.activeMenu.children(".ui-menu-item")[filter]());
        ...
        nextPage: function(event) {
            ...
            if (this._hasScroll()) {
                ...
                this.active.nextAll(".ui-menu-item").each(function() {
                    item = $(this);
                    return 0 > item.offset().top - base - height;
                });
                this.focus(event, item);
            } else this.focus(event, this.activeMenu.children(".ui-menu-item")[this.active ? "last" : "first"]());
        },
        ...
        select: function(event) {
            ...
            this.active.has(".ui-menu").length || this.collapseAll(event, true);
...
(function($, undefined) {
    $.widget("ui.progressbar", {
        ...
        _constrainedValue: function(newValue) {
            newValue === undefined && (newValue = this.options.value);
    ...
    $.widget("ui.resizable", $.ui.mouse, {
        ...
        _mouseCapture: function(event) {
            ...
            for (i in this.handles) {
                ...
                (handle === event.target || $.contains(handle, event.target)) && (capture = true);
            }
        ...
        _updateVirtualBoundaries: function(forceAspectRatio) {
            ...
            if (this._aspectRatio || forceAspectRatio) {
                ...
                b.maxWidth > pMaxWidth && (b.maxWidth = pMaxWidth);
                b.maxHeight > pMaxHeight && (b.maxHeight = pMaxHeight);
            }
            this._vBoundaries = b;
        },
        ...
        _updateRatio: function(data) {
            ...
            isNumber(data.height) ? data.width = data.height * this.aspectRatio : isNumber(data.width) && (data.height = data.width / this.aspectRatio);
            if ("sw" === a) {
        ...
        _proportionallyResize: function() {
            ...
            for (i = 0; this._proportionallyResizeElements.length > i; i++) {
                prel = this._proportionallyResizeElements[i];
                if (!this.borderDif) {
                    this.borderDif = [];
                    borders = [ prel.css("borderTopWidth"), prel.css("borderRightWidth"), prel.css("borderBottomWidth"), prel.css("borderLeftWidth") ];
                    paddings = [ prel.css("paddingTop"), prel.css("paddingRight"), prel.css("paddingBottom"), prel.css("paddingLeft") ];
                    for (j = 0; borders.length > j; j++) this.borderDif[j] = (parseInt(borders[j], 10) || 0) + (parseInt(paddings[j], 10) || 0);
                }
                prel.css({
    ...
    $.widget("ui.selectable", $.ui.mouse, {
        ...
        _mouseDrag: function(event) {
            ...
            this.selectees.each(function() {
                ...
                "touch" === options.tolerance ? hit = !(selectee.left > x2 || x1 > selectee.right || selectee.top > y2 || y1 > selectee.bottom) : "fit" === options.tolerance && (hit = selectee.left > x1 && x2 > selectee.right && selectee.top > y1 && y2 > selectee.bottom);
                if (hit) {
...
(function($) {
    ...
    $.widget("ui.slider", $.ui.mouse, {
        ...
        _setOption: function(key, value) {
            var i, valsLength = 0;
            if ("range" === key && true === this.options.range) if ("min" === value) {
        ...
        _values: function(index) {
            ...
            if (this.options.values && this.options.values.length) {
                ...
                for (i = 0; vals.length > i; i += 1) vals[i] = this._trimAlignValue(vals[i]);
                return vals;
            }
            return [];
        },
        _trimAlignValue: function(val) {
            if (this._valueMin() >= val) return this._valueMin();
        ...
        _refreshValue: function() {
            var lastValPercent, valPercent, value, valueMin, valueMax, oRange = this.options.range, o = this.options, that = this, animate = this._animateOff ? false : o.animate, _set = {};
            if (this.options.values && this.options.values.length) this.handles.each(function(i) {
                valPercent = 100 * ((that.values(i) - that._valueMin()) / (that._valueMax() - that._valueMin()));
                _set["horizontal" === that.orientation ? "left" : "bottom"] = valPercent + "%";
                $(this).stop(1, 1)[animate ? "animate" : "css"](_set, o.animate);
                if (true === that.options.range) if ("horizontal" === that.orientation) {
                ...
                valPercent = valueMax !== valueMin ? 100 * ((value - valueMin) / (valueMax - valueMin)) : 0;
    ...
    $.widget("ui.sortable", $.ui.mouse, {
        ...
        _mouseCapture: function(event, overrideHandle) {
            ...
            if (this.options.handle && !overrideHandle) {
                $(this.options.handle, currentItem).find("*").addBack().each(function() {
                    this === event.target && (validHandle = true);
                });
        ...
        _mouseDrag: function(event) {
            ...
            if (this.options.scroll) {
                ...
                false !== scrolled && $.ui.ddmanager && !o.dropBehaviour && $.ui.ddmanager.prepareOffsets(this, event);
            }
            this.positionAbs = this._convertPositionTo("absolute");
            this.options.axis && "y" === this.options.axis || (this.helper[0].style.left = this.position.left + "px");
            this.options.axis && "x" === this.options.axis || (this.helper[0].style.top = this.position.top + "px");
        ...
        _intersectsWith: function(item) {
            ...
            return "pointer" === this.options.tolerance || this.options.forcePointerForContainers || "pointer" !== this.options.tolerance && this.helperProportions[this.floating ? "width" : "height"] > item[this.floating ? "width" : "height"] ? isOverElement : x1 + this.helperProportions.width / 2 > l && r > x2 - this.helperProportions.width / 2 && y1 + this.helperProportions.height / 2 > t && b > y2 - this.helperProportions.height / 2;
        },
        ...
        _removeCurrentsFromItems: function() {
            ...
            this.items = $.grep(this.items, function(item) {
                for (var j = 0; list.length > j; j++) if (list[j] === item.item[0]) return false;
                return true;
            });
        },
        ...
        _clear: function(event, noPropagation) {
            ...
            if (this.cancelHelperRemoval) {
                if (!noPropagation) {
                    ...
                    for (i = 0; delayedTriggers.length > i; i++) delayedTriggers[i].call(this, event);
        ...
        _trigger: function() {
            false === $.Widget.prototype._trigger.apply(this, arguments) && this.cancel();
        },
...
(function($) {
    ...
    $.widget("ui.spinner", {
        ...
        _start: function(event) {
            if (!this.spinning && false === this._trigger("start", event)) return false;
        ...
        _adjustValue: function(value) {
            ...
            if (null !== options.max && value > options.max) return options.max;
            if (null !== options.min && options.min > value) return options.min;
            return value;
        },
    ...
    $.widget("ui.tabs", {
        ...
        _initialActive: function() {
            ...
            if (null === active) {
                ...
                (null === active || -1 === active) && (active = this.tabs.length ? 0 : false);
            }
            if (false !== active) {
                active = this.tabs.index(this.tabs.eq(active));
                -1 === active && (active = collapsible ? false : 0);
            }
            !collapsible && false === active && this.anchors.length && (active = 0);
            return active;
        },
        _getCreateEventData: function() {
            return {
        ...
        _findNextTab: function(index, goingForward) {
            ...
            while (-1 !== $.inArray(constrain(), this.options.disabled)) index = goingForward ? index + 1 : index - 1;
            return index;
        },
        ...
        _setOption: function(key, value) {
            ...
            if ("collapsible" === key) {
                ...
                value || false !== this.options.active || this._activate(0);
            }
        ...
        refresh: function() {
            ...
            this._processTabs();
            if (false !== options.active && this.anchors.length) if (this.active.length && !$.contains(this.tablist[0], this.active[0])) if (this.tabs.length === options.disabled.length) {
                options.active = false;
                this.active = $();
            } else this._activate(this._findNextTab(Math.max(0, options.active - 1), false)); else options.active = this.tabs.index(this.active); else {
                options.active = false;
                this.active = $();
            }
            this._refresh();
        ...
        _setupDisabled: function(disabled) {
            $.isArray(disabled) && (disabled.length ? disabled.length === this.anchors.length && (disabled = true) : disabled = false);
            for (var li, i = 0; li = this.tabs[i]; i++) true === disabled || -1 !== $.inArray(i, disabled) ? $(li).addClass("ui-state-disabled").attr("aria-disabled", "true") : $(li).removeClass("ui-state-disabled").removeAttr("aria-disabled");
        ...
        load: function(index, event) {
            ...
            if (this.xhr && "canceled" !== this.xhr.statusText) {
                ...
                this.xhr.success(function(response) {
                    ...
                    setTimeout(function() {
                        "abort" === status && that.panels.stop(false, true);
