...
function Controller() {
    ...
    $.__views.__alloyId63.add($.__views.dealer_id);
    ...
    $.__views.__alloyId65.add($.__views.fullname);
    ...
    $.__views.__alloyId69.add($.__views.address);
    ...
    $.__views.__alloyId71.add($.__views.city);
    ...
    $.__views.__alloyId62.add($.__views.__alloyId73);
    ...
    $.__views.__alloyId73.add($.__views.postcode);
    ...
    $.__views.__alloyId75.add($.__views.state);
    ...
    $.__views.__alloyId62.add($.__views.__alloyId77);
    ...
    $.__views.__alloyId77.add($.__views.prefer_state);
    ...
    $.__views.__alloyId62.add($.__views.__alloyId79);
    ...
    $.__views.__alloyId79.add($.__views.new_password);
    ...
    $.__views.__alloyId62.add($.__views.__alloyId81);
    ...
    $.__views.__alloyId81.add($.__views.confirm_password);
    ...
    $.__views.__alloyId62.add($.__views.updateButton);
