...
function Controller() {
    ...
    refreshPage ? $.__views.__alloyId99.addEventListener("touchend", refreshPage) : __defers["$.__views.__alloyId99!touchend!refreshPage"] = true;
    ...
    __defers["$.__views.__alloyId99!touchend!refreshPage"] && $.__views.__alloyId99.addEventListener("touchend", refreshPage);
    _.extend($, exports);
}
