...
function Controller() {
    ...
    $.__views.dispatcher_summary.add($.__views.__alloyId151);
    ...
    $.__views.__alloyId154.add($.__views.todayCommission);
    ...
    popup ? $.__views.__alloyId156.addEventListener("touchend", popup) : __defers["$.__views.__alloyId156!touchend!popup"] = true;
    ...
    $.__views.__alloyId157.add($.__views.monthCommission);
    ...
    $.__views.__alloyId151.add($.__views.list_form);
    ...
    __defers["$.__views.__alloyId156!touchend!popup"] && $.__views.__alloyId156.addEventListener("touchend", popup);
