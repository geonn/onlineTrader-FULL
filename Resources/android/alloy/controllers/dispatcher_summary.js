...
function Controller() {
    ...
    $.__views.dispatcher_summary.add($.__views.__alloyId133);
    ...
    $.__views.__alloyId136.add($.__views.todayCommission);
    ...
    $.__views.__alloyId139.add($.__views.monthCommission);
    ...
    popup ? $.__views.__alloyId141.addEventListener("touchend", popup) : __defers["$.__views.__alloyId141!touchend!popup"] = true;
    $.__views.list_form = Ti.UI.createScrollView({
        height: "auto",
        id: "list_form"
    });
    $.__views.__alloyId133.add($.__views.list_form);
    ...
    __defers["$.__views.__alloyId141!touchend!popup"] && $.__views.__alloyId141.addEventListener("touchend", popup);
    _.extend($, exports);
}
