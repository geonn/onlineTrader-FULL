...
function Controller() {
    ...
    $.__views.header.add($.__views.__alloyId90);
    ...
    $.__views.header.add($.__views.__alloyId91);
    ...
    $.__views.composetracking_win.add($.__views.__alloyId94);
    ...
    $.__views.__alloyId94.add($.__views.trackingMessage);
