...
@interface OnlineTraderObject : KrollCoverageObject {
#else
@interface OnlineTraderObject : KrollObject {
#endif
@private
...
extern NSString * OnlineTrader$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	OnlineTraderObject *_onlinetrader;
    KrollObject* console;
	BOOL shutdown;
