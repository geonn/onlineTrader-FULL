...
/**
 The base class for all OnlineTrader modules
 */
...
/**
 OnlineTrader Platform calls this method on startup.
 */
-(void)startup;

/**
 OnlineTrader Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 OnlineTrader Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 OnlineTrader Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 OnlineTrader Platform calls this method on resume.
 @param sender The sender of the event.
 */
