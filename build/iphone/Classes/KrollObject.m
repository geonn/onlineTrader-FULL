...
//@interface OnlineTraderObject : NSObject
//@end

@interface OnlineTraderObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[OnlineTraderObject class]])
		{
			for (NSString *key in [[(OnlineTraderObject*)o modules] allKeys])
			{
