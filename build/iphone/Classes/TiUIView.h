...
/**
 Base class for all OnlineTrader views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the OnlineTrader view hierarchy (such as wrapped iOS UIViews) was touched.
