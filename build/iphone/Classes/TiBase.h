...
// in simulator we redefine to format for OnlineTrader Developer console
...
{\
	NSString * exceptionName = [@"org.onlinetrader." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.onlinetrader";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIOnlineTraderNativeItemNone = -1, 
	UIOnlineTraderNativeItemSpinner = -2,
	UIOnlineTraderNativeItemProgressBar = -3,
	
	UIOnlineTraderNativeItemSlider = -4,
	UIOnlineTraderNativeItemSwitch = -5,
	UIOnlineTraderNativeItemMultiButton = -6,
	UIOnlineTraderNativeItemSegmented = -7,
	
	UIOnlineTraderNativeItemTextView = -8,
	UIOnlineTraderNativeItemTextField = -9,
	UIOnlineTraderNativeItemSearchBar = -10,
	
	UIOnlineTraderNativeItemPicker = -11,
	UIOnlineTraderNativeItemDatePicker = -12,
	
	UIOnlineTraderNativeItemInfoLight = -13,
	UIOnlineTraderNativeItemInfoDark = -14,
	
	UIOnlineTraderNativeItemDisclosure = -15,
	
	UIOnlineTraderNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all OnlineTrader instances of
