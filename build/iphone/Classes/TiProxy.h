...
//Rare exceptions to indicate a bug in the _onlinetrader code (Eg, function that a subclass should have implemented)
...
/**
 The base class for OnlineTrader proxies.
 */
